...
android.add_jars = .buildozer/android/platform/build-arm64-v8a/build/libs_collections/Electrum/jar/*.jar
...
p4a.local_recipes = %(source.dir)s/contrib/android-qt/p4a_recipes/
